...
typedef char utf8_t; // The type of a single UTF-8 character
typedef uint16_t utf16_t; // The type of a single UTF-16 character
typedef char viscii_t; // The type of a single UTF-8 character
...
size_t utf8_to_viscii(
    utf8_t const* utf8, size_t utf8_len, 
    viscii_t* viscii,     size_t viscii_len
);
